...
var _reduxPromise = __webpack_require__(27);
...
var enhancers = [];
var middleware = [_reduxPromise2.default, _reduxLogger2.default, _reduxThunk2.default];
var store = (0, _redux.createStore)((0, _redux.combineReducers)({ counter: counter, health: health }), initialState, _redux.compose.apply(undefined, [_redux.applyMiddleware.apply(undefined, middleware)].concat(enhancers)));
...
function combineReducers(reducers) {
  console.log('combineReducers1');
  console.log(reducers);
  var reducerKeys = Object.keys(reducers);
  console.log('combineReducers2');
...
function applyMiddleware() {
  ...
  return function (createStore) {
    return function (reducer, preloadedState, enhancer) {
      ...
      var data = __WEBPACK_IMPORTED_MODULE_0__compose__["a" /* default */].apply(undefined, chain)
      console.log('>>>>>>>');
      console.log(data);
  ...
  return function (_ref) {
    ...
    return function (next,arg) {
      ...
      return function (action) {
        console.log('createThunkMiddleware1');
        console.log(action);
...
var _fluxStandardAction = __webpack_require__(28);
...
function promiseMiddleware(_ref) {
  ...
  return function (next) {
    console.log('promiseMiddleware1');
    console.log(next);
    return function (action) {
    console.log('promiseMiddleware2');
      console.log(action);
...
var _lodashIsplainobject = __webpack_require__(29);
