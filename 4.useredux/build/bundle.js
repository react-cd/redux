...
var thunk = __webpack_require__(25);
var promiseMiddleware = __webpack_require__(26);
var reduxLogger = __webpack_require__(32);
// let store = createStore(counter);
var initialState = {
    name: '1'
};
var enhancers = [];
var middleware = [thunk, promiseMiddleware, reduxLogger];
var store = createStore(counter, initialState, compose.apply(undefined, [applyMiddleware.apply(undefined, middleware)].concat(enhancers)));
...
var _fluxStandardAction = __webpack_require__(27);
...
var _lodashIsplainobject = __webpack_require__(28);
